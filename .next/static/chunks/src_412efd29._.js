...
function AppProvider(param) {
    let { children } = param;
    _s();
    const [cakes, setCakes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [cart, setCart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            // Initial catalog from placeholders
            const initialCakes = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$placeholder$2d$images$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaceHolderImages"].filter({
                "AppProvider.useEffect.initialCakes": (img)=>img.id !== 'bakery-hero'
            }["AppProvider.useEffect.initialCakes"]).map({
                "AppProvider.useEffect.initialCakes": (img, index)=>({
                        id: img.id,
                        name: img.description.split(' ').map({
                            "AppProvider.useEffect.initialCakes": (w)=>w.charAt(0).toUpperCase() + w.slice(1)
                        }["AppProvider.useEffect.initialCakes"]).join(' '),
                        price: 25 + index * 5,
                        description: "Our finest ".concat(img.description, ". Handcrafted with love."),
                        imageUrl: img.imageUrl,
                        category: index % 2 === 0 ? 'Signature' : 'Limited Edition'
                    })
            }["AppProvider.useEffect.initialCakes"]);
    ...
    const addToCart = (cake)=>{
        setCart((prev)=>{
            ...
            if (existing) {
                return prev.map((item)=>item.id === cake.id ? {
                        ...item,
...
_s(AppProvider, "oBnivdnb0tSl+IZTViySVhsuUcs=");
_c = AppProvider;
...
//# sourceMappingURL=src_412efd29._.js.map