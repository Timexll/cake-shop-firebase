...
function AppProvider({ children }) {
    const [cakes, setCakes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const initialCakes = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$placeholder$2d$images$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlaceHolderImages"].filter((img)=>img.id !== 'bakery-hero').map((img, index)=>({
                id: img.id,
                name: img.description.split(' ').map((w)=>w.charAt(0).toUpperCase() + w.slice(1)).join(' '),
                price: 25 + index * 5,
                description: `Our finest ${img.description}. Handcrafted with love.`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__badecb02._.js.map